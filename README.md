...
```sh
git clone https://github.com/camlow325/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
[Fork it](https://github.com/camlow325/dotfiles/fork), remove what you don't
